...
public class KakaoPayService {
	...
	public ReadyResponseDTO payReady(int totalPrice,String orderId) {
		...
		parameters.put("approval_url", "http://localhost:8080/cash/result");
		parameters.put("cancel_url", "http://localhost:8080/cash/cancled");
		parameters.put("fail_url", "http://localhost:8080/cash/failed");
